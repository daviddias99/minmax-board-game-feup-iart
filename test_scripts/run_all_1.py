...
def main():
    ...
    run_times(['C','C', [3,3], [1,3], [True,True], [True,True]],5, f)
    run_times(['C','C', [3,3], [3,1], [True,True], [True,True]],5, f)
    run_times(['C','C', [3,3], [1,2], [True,True], [True,True]],5, f)
    run_times(['C','C', [3,3], [2,1], [True,True], [True,True]],5, f)
    run_times(['C','C', [3,3], [2,3], [True,True], [True,True]],5, f)
    run_times(['C','C', [3,3], [3,2], [True,True], [True,True]],5, f)
